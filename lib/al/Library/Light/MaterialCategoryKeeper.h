...
public:
    ...
    MaterialCategoryKeeper(GraphicsSystemInfo*);
    ...
    void requestParam(s32, s32, const MaterialCategoryParam&);
    ...
    void registerModelMaterialCategory(ModelMaterialCategory*);
