...
sead::FrameBuffer* getSceneFrameBufferMain(const Scene*);
agl::DrawContext* getSceneDrawContext(const Scene*);
sead::FrameBuffer* getSceneFrameBufferConsole(const Scene*);
sead::FrameBuffer* getSceneFrameBufferHandheld(const Scene*);
sead::FrameBuffer* getSceneFrameBufferMainAspect(const Scene*);
