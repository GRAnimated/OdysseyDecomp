...
const sead::LogicalFrameBuffer* getSceneFrameBufferMain(const Scene*);
agl::DrawContext* getSceneDrawContext(const Scene*);
const sead::LogicalFrameBuffer* getSceneFrameBufferConsole(const Scene*);
const sead::LogicalFrameBuffer* getSceneFrameBufferHandheld(const Scene*);
const sead::LogicalFrameBuffer* getSceneFrameBufferMainAspect(const Scene*);
...
void* getDemoActorList(const Scene*);  // TODO: Unknown return type
void* getDemoActorNum(const Scene*);   // TODO: Unknown return type
...
void* getPreLoadFileListArc();  // TODO: Unknown return type
