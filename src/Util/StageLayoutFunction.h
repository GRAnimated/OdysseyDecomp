...
bool isExistLabelInSystemMessageWithFileName(al::IUseMessageSystem const*, const char*,
                                             const char*);
bool isExistLabelInStageMessageWithFileName(al::IUseMessageSystem const*, const char*, const char*);
...
const char* getCheckpointLabelPrefix(void);
...
void getCollectBgmMessage(al::IUseMessageSystem const*, const CollectBgm*);
