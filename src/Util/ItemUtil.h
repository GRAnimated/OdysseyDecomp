...
bool initItemByPlacementInfo(al::LiveActor*, const al::ActorInitInfo&, bool);
bool tryInitItemByPlacementInfo(al::LiveActor*, const al::ActorInitInfo&, bool);
bool initItem2DByPlacementInfo(al::LiveActor*, const al::ActorInitInfo&);
...
bool isEndAppearShine(Shine const*);
bool isGotShine(Shine const*);
bool isAliveShine(Shine const*);
bool isMainShine(Shine const*);
void updateHintTrans(Shine const*, const sead::Vector3f&);
...
bool tryAppearMultiCoinFromObj(al::LiveActor*, const sead::Vector3f&, const sead::Quatf&, s32,
                               float);
