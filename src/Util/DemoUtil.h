...
namespace rs {
void createDemoPeachWedding(const al::ActorInitInfo&);
void createDemoCapManHeroine(const al::ActorInitInfo&);
...
void getRequestActor(const al::Scene*);
bool requestValidateDemoSkip(IUseDemoSkip*, const al::LiveActor*);
...
void createCaptionInfoHolder(const char*);
...
void tryGetBossBarrierField(const al::LiveActor*);
...
void getRandomActionIndexDemoChangeWorld(const al::LiveActor*);
void setDemoInfoDemoName(const al::Scene*, const char*);
void getDemoInfoDemoName(const al::LiveActor*);
bool isTriggerDemoCancel(al::IUseSceneObjHolder const*);
