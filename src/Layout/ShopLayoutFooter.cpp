...
// NON_MATCHING: compiler schedules IUseLayout* subobject cast into x20 before getSystemMessageString
// but our compiler schedules it inline at the setPaneString call site
