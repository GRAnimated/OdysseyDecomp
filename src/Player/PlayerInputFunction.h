...
public:
    ...
    static sead::Vector2f getMoveInputStick(const al::LiveActor* actor, s32 port, s32 stick);
    ...
    static u32 getNoInputJudgeKeyMask(const al::LiveActor* actor, s32 port);
    ...
    static bool isTriggerSeparateCameraReset(const al::LiveActor* actor, s32 port, s32 controller);
    ...
    static sead::Vector2f getCameraMoveInput(const al::LiveActor* actor, s32 port, s32 camera,
                                  bool isSeparate);
};
