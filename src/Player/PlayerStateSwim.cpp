...
// NON_MATCHING: current helper is 520 bytes vs target 532; target keeps a packed 64-bit surface-found/distance snapshot.
...
// NON_MATCHING: missing the leading swim-velocity helper; restore its source before tuning codegen.
...
// NON_MATCHING: compiler preserves this+0x20 in X21 across the first-step branch.
